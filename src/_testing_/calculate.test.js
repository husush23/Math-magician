...
describe('Check all buttons to work and calculate correctly', () => {
  ...
  test('If buttonName is ".", update next if there is a next number and it does not already contain a decimal point', () => {
    const obj = {
      total: null,
      next: '12',
    };
  ...
  test('If buttonName is "=" and there is a next number and an operation, calculate the total and clear the next number and operation', () => {
    const obj = {
      total: 10,
      next: 20,
      operation: '+',
  ...
  test('If buttonName is "+/-" and there is a next number, negate it', () => {
    const obj = {
      total: null,
      next: '12',
    };
  ...
  test('If buttonName is "+/-" and there is a total, negate it', () => {
    const obj = {
      total: 12,
      next: null,
    };
  ...
  test('If the user pressed an operation after pressing "=" and there is a total but no operation, set the operation to the buttonName', () => {
    const obj = {
      total: 12,
      next: null,
      operation: null,
